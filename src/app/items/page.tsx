...
export default function ItemsPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-white via-gray-50 to-white">
      ...
      {/* Loading State - Premium Skeleton with stagger */}
      {loading && (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {Array.from({ length: 8 }).map((_, i) => (
              <div
                key={i}
                className="rounded-2xl border border-gray-200/50 overflow-hidden bg-white/50 backdrop-blur-sm shadow-sm"
                style={{
              ...
              >
                ...
                <div className="p-5 space-y-3.5">
                  ...
                  <div className="flex gap-3 pt-2">
                    <div className="w-8 h-8 rounded-full bg-gray-200 animate-shimmer flex-shrink-0" />
                    <div className="h-3 bg-gray-200 rounded-lg w-1/3 animate-shimmer flex-1" />
                  </div>
                </div>
              </div>
            ))}
